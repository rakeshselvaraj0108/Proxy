...
MANIFEST_PATH = KNOWLEDGE_ROOT / "telecom_corpus_manifest.json"
REPORT_PATH = KNOWLEDGE_ROOT / "telecom_ingestion_report.json"
SKIP_PARTS = {"metadata", "chunks", "knowledge_graph", "templates", "synthetic_cases"}
...
def main() -> None:
            ...
            for index, chunk in enumerate(doc_chunks):
                record = {
                    ...
                    "metadata": {
                        ...
                        "category": meta.get("category", rel.parts[0] if rel.parts else "telecom"),
    ...
    manifest = {
        ...
        "graph_seed_files": [
            "knowledge/telecom/knowledge_graph/telecom_entities.jsonl",
            "knowledge/telecom/knowledge_graph/telecom_relationships.jsonl",
        ],
        "files": files,
    }
    ...
    report.update({
        ...
        "local_corpus": {
            ...
            "manifest_file": "knowledge/telecom/telecom_corpus_manifest.json",
        },
    })
