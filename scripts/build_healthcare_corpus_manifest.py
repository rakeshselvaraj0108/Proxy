...
KNOWLEDGE_ROOT = ROOT / "knowledge" / "healthcare"
CHUNK_PATH = KNOWLEDGE_ROOT / "chunks" / "healthcare_chunks.jsonl"
MANIFEST_PATH = KNOWLEDGE_ROOT / "healthcare_corpus_manifest.json"
REPORT_PATH = KNOWLEDGE_ROOT / "healthcare_ingestion_report.json"
...
def main() -> None:
            ...
            for index, chunk in enumerate(doc_chunks):
                record = {
                    ...
                    "metadata": {
                        ...
                        "category": meta.get("category", rel.parts[0] if rel.parts else "healthcare"),
    ...
    manifest = {
        ...
        "graph_seed_files": [
            "knowledge/healthcare/knowledge_graph/healthcare_entities.jsonl",
            "knowledge/healthcare/knowledge_graph/healthcare_relationships.jsonl",
        ],
        "files": files,
    }
    ...
    report.update({
        ...
        "local_corpus": {
            ...
            "manifest_file": "knowledge/healthcare/healthcare_corpus_manifest.json",
        },
    })
