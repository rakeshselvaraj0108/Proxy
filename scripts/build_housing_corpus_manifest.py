...
KNOWLEDGE_ROOT = ROOT / "knowledge" / "housing"
CHUNK_PATH = KNOWLEDGE_ROOT / "chunks" / "housing_chunks.jsonl"
MANIFEST_PATH = KNOWLEDGE_ROOT / "housing_corpus_manifest.json"
REPORT_PATH = KNOWLEDGE_ROOT / "housing_ingestion_report.json"
...
def main() -> None:
            ...
            for index, chunk in enumerate(doc_chunks):
                record = {
                    ...
                    "metadata": {
                        ...
                        "category": meta.get("category", rel.parts[0] if rel.parts else "housing"),
    ...
    manifest = {
        ...
        "graph_seed_files": [
            "knowledge/housing/knowledge_graph/housing_entities.jsonl",
            "knowledge/housing/knowledge_graph/housing_relationships.jsonl",
        ],
        "files": files,
    }
    ...
    report.update({
        ...
        "local_corpus": {
            ...
            "manifest_file": "knowledge/housing/housing_corpus_manifest.json",
        },
    })
