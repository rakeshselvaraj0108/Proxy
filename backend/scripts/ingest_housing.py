"""
Housing Domain — Fast Ingestion (no Gemini KG extraction per chunk)
Reads all files under knowledge/housing/, chunks them, embeds, stores in
Qdrant. Housing had no dedicated ingestion script -- knowledge/housing/
already has real downloaded source material (RERA, tenancy law, etc. from
housing_source_registry.json) sitting unindexed.
"""
...
async def run_pipeline():
    print(f"Housing Fast Ingest — {KNOWLEDGE_ROOT}")
    docs = total_chunks = 0
